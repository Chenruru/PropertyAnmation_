package test.bwie.com.propertyanmation_;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {//透明度动画
            ...
            case R.id.animation_group3://重复的透明度动画
                ...
                objectAnimator2.setRepeatCount(3);  //重复的次数
            ...
            case R.id.animation_group4://重复的位移动画
                ...
                objectAnimatorTranslate3.setRepeatCount(3);//重复的次数
            ...
            case R.id.animation_frame:
                ...
                objectAnimatorBg.setDuration(3000);   //动画的时间
